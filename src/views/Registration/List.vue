            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm opacity-60">
                        Total registration: {{ registrationStore.registrations?.length}}
                    </p>
                </div>
                <div class="flex gap-3">
                    <div class="relative">
                            <input 
                                v-model="registrationStore.search" 
                                type="text" 
                                placeholder="Search"
                    ...
                    <router-link to="/registrations/create" class="btn btn-primary text-white">
