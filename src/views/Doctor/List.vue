    ...
    <div class="p-6 bg-gray-100 min-h-screen">
        ...
        <div class="p-6 space-y-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold">Patient's Queuing</h2>
                    <p class="text-sm opacity-60">Total patients: {{ 0 }}</p>
                </div>
                <div>
                    <div class="relative">
                        <input v-model="queueStore.search" type="text" placeholder="Search" class="input input-bordered w-64 pl-10" />
                ...
                <div class="card-body p-0">
                    <div class="overflow-x-auto border border-base-300/60 rounded-2xl">
                        <table class="table w-full">
                            ...
                            <tbody>
                                <tr v-for="queue in paginatedData" :key="queue.id" class="hover:bg-base-200/40 transition-colors duration-200">
